...
def process_resume(self, resume_id: int):
    ...
    try:
        ...
        if resume.parsed_data and isinstance(resume.parsed_data, dict) and resume.parsed_data.get('email'):
            extracted_data = resume.parsed_data
            ...
            resume.parsed_data = extracted_data
            db.commit()
